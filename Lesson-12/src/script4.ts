...
{       
    ...
    function drawStep(arr: number[], activeIdx: number) {
        ...
        arr.forEach((num, idx) => {
            ...
            if (idx < arr.length - 1) document.write(`<span style="margin: 0 4px;">,</span>`);
        });
    ...
    function bubbleSortVisual(data: number[]) {
        let arr = [...data];
    ...
    function shakerSortVisual(data: number[]) {
        let arr = [...data];
    ...
    function insertionSortVisual(data: number[]) {
        let arr = [...data];
